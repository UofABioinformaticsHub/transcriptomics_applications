...
<button onclick="myFunction('glimpse')">Another way to preview data</button>
<div id="glimpse" style="display: none;">

An additional way to preview your data is to use the function `glimpse()`, which offers similar information to just typing the name of the `tibble`, but may yield a few more insights into the first few values.
...
There is considerable merit to this as it simply sidesteps this entire problem.
