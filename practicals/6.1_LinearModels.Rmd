...
A version of this prepared as an `ExpressionSet` is available for direct import into your VM.

```{r}
eset <- url("https://github.com/UofABioinformaticsHub/transcriptomics_applications/raw/master/practicals/data/pi16_2way_eset.rds") %>%
    read_rds
```
...
# Working With More Complicated Designs
