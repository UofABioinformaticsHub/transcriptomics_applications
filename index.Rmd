...
pracs <- tribble(
    ...
    7, "2020-04-27", "Alignment and Quantification", "Zhipeng Qu", "", "More Complex Designs", "practicals/7.1_More_Complex_Designs.html",
    ...
    9, "2020-05-11", "Enrichment Analysis", "Stephen Pederson", "lectures/8_EnrichmentTesting.pdf", "Differential Expression Using edgeR", "",
    NA_integer_, NA_character_, NA_character_, NA_character_, NA_character_, "Enrichment Strategies", "",
    10, "2020-05-18", "Network Analysis", "TBC", "", "WGCNA", "",
    NA_integer_, NA_character_, NA_character_, NA_character_, NA_character_, "WGCNA", "",
    11, "2020-05-25", "Single Cell RNA-Seq", "Stephen Pederson", "", "scRNA", "",
    NA_integer_, NA_character_, NA_character_, NA_character_, NA_character_, "scRNA", "",
    12, "2020-06-01", "Transcriptome Assembly", "Terry Bertozzi", "", "Using StringTie to Define New Transcripts", "",
    NA_integer_, NA_character_, NA_character_, NA_character_, NA_character_, "Checking the Quality of a Transcriptome Assembly", "",
...
ass <- tribble(
    ...
    "assignments/A3.html", "Differential Analysis", "2020-05-12", "",
